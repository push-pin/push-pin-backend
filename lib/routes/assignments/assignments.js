...
module.exports = Router()
  .post('/', checkAuth(TEACHER, TA), (req, res, next) => {
    const { courseId, type, title, instructions, dateAvailable, dateDue, dateClosed } = req.body;
    Assignment
      .create({ courseId, type, title, instructions, dateAvailable, dateDue, dateClosed })
  ...
  .get('/bycourse/:courseId', (req, res, next) => {
  ...
  .get('/bycourse/inactive/:courseId', (req, res, next) => {
    const courseId = req.params.courseId;
